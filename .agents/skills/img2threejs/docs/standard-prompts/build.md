...
**The one thing that makes this prompt not block:** the forge scripts _scaffold_, they do not
_assess_. A freshly generated spec carries `primaryType: "unassessed"`, eight complexity scores of
