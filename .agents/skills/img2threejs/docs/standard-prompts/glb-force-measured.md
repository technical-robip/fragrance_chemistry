...
Without it, a build measures the GLB and then _approximates_ — a diameter becomes "about right", a
...
an empty `detailInventory`, a `colorMaterialRecipe` nobody derived. Every one of those asks _"did
you infer this responsibly?"_
