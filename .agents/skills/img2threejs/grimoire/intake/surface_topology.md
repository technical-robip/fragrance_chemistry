...
Use this reference before assigning a `primitive` to any component. Classifying the _kind_ of
...
3. Is the _silhouette itself_ affected by fine detail (ridges/rivets/panel lines) with no other
